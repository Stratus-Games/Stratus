...
async function n(a,n,s){
  ...
  const o = await s.request(
    ...
    a.fetch.method,
    a.fetch.body,
    headers, // ✅ now always iterable
    null
  );

  if(!function(){
    if(null===t){
      const a=new MessageChannel,n=new ReadableStream;
      let s;
      try{e.call(a.port1,n,[n]),s=!0}catch(e){s=!1}
      return t=s,s
    }
    return t
...
function l(t){
  t.onmessage=async t=>{
    const l=t.data.port,i=t.data.message;
      ...
      try{
        ...
        if("bare-mux-remote"===i.client.function)
          ...
          try{
            ...
            throw e.cause="The BareTransport provided was invalid. Common causes of this are a default export that is not a class that implements BareTransport if you are using `setTransport()`",
            e
          }
      ...
      try{
        ...
        await async function(t,a,n){
          const[s,o]=n.connect(
            ...
            a=>{e.call(t.websocket.channel,{type:"open",args:[a]})},
